...
@Component
public class CaliberQueryBuilder extends BaseQueryBuilder<CaliberModel> {

    private final MongoTemplate mongoTemplate;
    private final QuerySecurityValidator validator;

    public CaliberQueryBuilder(MongoTemplate mongoTemplate) {
    ...
    public static final Map<String, Class<?>> FIELD_TYPES = Map.of(
            ...
            "type", CaliberType.class,
            "standard", CaliberStandard.class
    );
    ...
    public PageResponse<CaliberModel> search(SearchRequest request, int page, int size) {
        ...
        List<CaliberModel> content =
                mongoTemplate.find(query, CaliberModel.class);

        long total =
                mongoTemplate.count(new Query(), CaliberModel.class);

        return PageResponse.<CaliberModel>builder()
                .content(content)
                .totalElements(total)
