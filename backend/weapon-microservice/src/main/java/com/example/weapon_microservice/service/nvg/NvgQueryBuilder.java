...
@Component
public class NvgQueryBuilder extends BaseQueryBuilder<NvgModel> {

    private final MongoTemplate mongoTemplate;
    private final QuerySecurityValidator validator;

    public NvgQueryBuilder(MongoTemplate mongoTemplate) {
    ...
    public static final Map<String, Set<String>> FIELD_OPERATORS = Map.of(
            ...
            "reference", Set.of("EQ"),
            "generation", Set.of("EQ", "IN"),
            "range", Set.of("GTE", "LTE", "EQ"),
            "status", Set.of("EQ", "IN")
    );
    ...
    public PageResponse<NvgModel> search(SearchRequest request, int page, int size) {
        ...
        List<NvgModel> content =
                mongoTemplate.find(query, NvgModel.class);

        long total =
                mongoTemplate.count(new Query(), NvgModel.class);

        return PageResponse.<NvgModel>builder()
                .content(content)
                .totalElements(total)
