...
@Component
public class WeaponStockQueryBuilder extends BaseQueryBuilder<WeaponStockModel> {

    private final MongoTemplate mongoTemplate;
    private final QuerySecurityValidator validator;

    public WeaponStockQueryBuilder(MongoTemplate mongoTemplate) {
    ...
    public static final Map<String, Class<?>> FIELD_TYPES = Map.of(
            ...
            "material", StockMaterial.class,
            "atachmentMethod", StockAtachmentSystem.class,
    ...
    public PageResponse<WeaponStockModel> search(SearchRequest request, int page, int size) {
        ...
        List<WeaponStockModel> content =
                mongoTemplate.find(query, WeaponStockModel.class);

        long total =
                mongoTemplate.count(new Query(), WeaponStockModel.class);

        return PageResponse.<WeaponStockModel>builder()
                .content(content)
                .totalElements(total)
