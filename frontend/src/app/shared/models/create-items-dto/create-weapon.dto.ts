...
export const CREATE_WEAPON_MODEL: ItemFormModel = {
  sections: [
    {
      title: 'Basic',
      fields: [
...

    {
      title: 'Performance',
      fields: [
        { key: 'effectiveDistance', label: 'Effective Distance', type: 'NUMBER', value: 0 },
        { key: 'fireRate', label: 'Fire Rate', type: 'NUMBER', value: 0 },
        { key: 'barrelLength', label: 'Barrel Length', type: 'NUMBER', value: 0 }
      ]
    },
